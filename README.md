...
>>> results = mbar.compute_expectations(A_kn, return_dict=True)
```
...
* The automatic equilibration detection method provided in `pymbar.timeseries.detect_equilibration()` is described here:
