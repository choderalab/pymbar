...
def _deprecate(fn, old_name):
    ...
    old_name : str
        Original name that to be deprecated
    ...
    def deprecated(*args, **kwargs):
        warn(f"`{old_name}` will be deprecated in pymbar 4+. Please update your code to use `{fn.__name__}` instead.", DeprecationWarning, stacklevel=2)
