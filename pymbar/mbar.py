...
class MBAR(object):
    ...
    def get_free_energy_differences(self, compute_uncertainty=True, uncertainty_method='svd-ew', warning_cutoff=1.0e-10, return_theta=False):
        ...
        if compute_uncertainty or return_theta:
            ...
            Theta_ij = self._compute_covariance_matrix(
    ...
    def compute_expectation(self, A_n, compute_uncertainty=True, uncertainty_method="svd-ew", warning_cutoff=1.0e-10, return_theta=False):
        ...
        A_n = ensure_type(A_n, np.float64, 1, 'N_k', (self.n_samples))
