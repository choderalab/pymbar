...
from pymbar.testsystems import harmonic_oscillators_old
...
def test_02_harmonic_oscillators_example():
    ...
    x_kn, u_kln, N_k = harmonic_oscillators_old.harmonic_oscillators_example(ref.N_k, ref.O_k, ref.K_k * ref.beta, seed=seed)
    eq(N_k, ref.N_k)
...
class TestHarmonicOscillator(object):
    def setup(self):
        ...
        self.x_kn, self.u_kln, self.N_k = harmonic_oscillators_old.harmonic_oscillators_example(self.N_k, self.O_k, self.K_k * self.beta, seed=seed)
