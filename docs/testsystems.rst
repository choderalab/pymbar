...
The :mod:`pymbar.testsystems` module contains a number of test systems with analytically or numerically computable expectations or free energies we use to validate its implementation.
